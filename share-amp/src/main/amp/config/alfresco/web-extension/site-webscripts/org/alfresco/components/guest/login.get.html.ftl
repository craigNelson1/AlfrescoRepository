...
<@markup id="html">
   <@uniqueIdDiv>
      ...
      <@markup id="header">
         <div style="height: 210px;width: 19em;background: transparent url(/share/components/images/redwing-logo-sm-2.png)no-repeat;background-size: 231px;margin-bottom: 6em; margin-top: 1em;"></div>
      </@markup>
      ...
      <@markup id="form">
         <form id="${el}-form" accept-charset="UTF-8" method="post" action="${loginUrl}" class="form-fields login ${edition}" style="float: left;margin: -170px 44px; width: 400px;">
      ...
      <@markup id="footer">
         <div class="copy" style="padding: 1.5em;">${msg("label.copyright")}</div>
      </@markup>
