   ...
   <@uniqueIdDiv>
      ...
      <div class="footer ${fc.getChildValue("css-class")!"footer-com"}">
         <span class="copyright">
            <a href="#" onclick="Alfresco.module.getAboutShareInstance().show(); return false;"><img src="${url.context}/res/components/images/redwing-logo-sm-2.png" style="width: 100px;" alt="${fc.getChildValue("alt-text")!"Alfresco Community"}" border="0"/></a>
