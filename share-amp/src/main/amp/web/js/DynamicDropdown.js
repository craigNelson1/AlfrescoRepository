...
(function()
{
   ...
   YAHOO.extend(RWAD.DynamicDropdown.Event, Alfresco.component.Base,
   {
      ...
      {
    	  if(this.options.siteName!="" && this.options.dataListName!="" && this.options.fieldName!="")
    	  {
    		  this.onRenderSpecifiedFields();
    		return;  
    	  }
      ...
      onRenderSpecifiedFields: function DynamicDropdown_onRenderSpecifiedFields()
      {
